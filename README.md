<div align="center">
  ...
  <p>
    <a href="https://github.com/Fourgetu/Remnawave/releases/tag/custom-v0.2.12">
      <img src="https://img.shields.io/badge/release-custom--v0.2.12-0969da?style=flat-square" alt="custom-v0.2.12">
    </a>
...
当前正式版本：[`custom-v0.2.12`](https://github.com/Fourgetu/Remnawave/releases/tag/custom-v0.2.12)

| 组件 | 正式版本 / 镜像 |
| --- | --- |
| Panel / Backend | `ghcr.io/fourgetu/remnawave-backend:custom-v0.2.12` |
| Frontend | `Fourgetu/frontend:custom-v0.2.12`，已内嵌到 Backend 镜像 |
| Node | `ghcr.io/fourgetu/remnawave-node:custom-v0.2.9` |
| 架构 | `linux/amd64`、`linux/arm64` |

本版新增 Mixed 入站 SOCKS5 / HTTP 单节点代理链接快捷复制。Panel 使用 `custom-v0.2.12`，Node 有意继续使用已验证的 `custom-v0.2.9` 镜像。
...
- Xray 正式可用预设包括 VLESS Reality Vision、SS2022 AES-128/AES-256，以及现有 Xray 模板。
- sing-box 正式可用预设包括 VLESS Reality Vision、SS2022 AES-128/AES-256、Hysteria2 和 Mixed。
- SS2022 ChaCha20 当前不支持 Remnawave Managed Users，因此 Quick Protocol / Quick Deploy 不开放该 method。
...
```bash
bash <(curl -fsSL https://github.com/Fourgetu/Remnawave/releases/download/custom-v0.2.12/install-panel.sh | sed 's/\r$//')
```
...
4. 拉取 `custom-v0.2.12` Backend 镜像并启动 Panel、PostgreSQL 和 Valkey。
...
```bash
bash <(curl -fsSL https://github.com/Fourgetu/Remnawave/releases/download/custom-v0.2.12/install-node.sh | sed 's/\r$//')
```
...
- [custom-v0.2.12 Release Notes](./RELEASE_NOTES_custom-v0.2.12.md)
